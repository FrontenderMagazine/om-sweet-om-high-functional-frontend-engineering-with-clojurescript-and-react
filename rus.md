...
Философия ядра дизайна в Реакте по существу функциональная, и во много это более соответствует функциональному языку ClojureScript чем Javascript. Om построен на React, принимая его идеи дальше, используя иммутабельные структуры данных для представления состояния приложения, тем самым увеличивая производительность и архитектурные преимущества.
