...
Судя по нашему опыту построения приложений для веба, бэкенда и iOS, высокая степень
связанности и большинство ошибок возникают в процессе управления состояниями
приложения. С [ClojureScript][3] и [Om][4] (интерфейс на ClojureScript для
[React][5]) мы наконец-то нашли ту архитектуру, которая примет на себя бо́льшую
...
Тогда как Clojure привносит функциональную парадигму программирования в структуры данных веба, [React][5] привносит ее же в DOM, предоставляя простой и мощный инструмент для построения компонентных пользовательских интерфейсов. Если вы еще с ним не знакомы, мы очень рекомендуем вам ознакомиться с тем, почему [Facebook создали React][16]. В документации по React приведена его главная задача: «Просто выразите то, как приложение должно выглядеть в определенный момент времени, и React будет автоматически управлять всеми изменениями UI, когда вы изменяете данные».
...
**Спасибо:** [Скоту Рабину (Scott Rabin)][26], [Кевину Линьярду (Kevin Lynagh)][27] и [Шону Грову (Sean Grove)][28] за вычитку черновика этой статьи.
...
[Работа курсоров]: https://github.com/FrontenderMagazine/om-sweet-om-high-functional-frontend-engineering-with-clojurescript-and-react/raw/master/img/Cursor-example-rus.png "Работа курсоров"
[Пример подписки на тему со стрелочками]: https://github.com/FrontenderMagazine/om-sweet-om-high-functional-frontend-engineering-with-clojurescript-and-react/raw/master/img/follow_example_with_arrows.png "Пример подписки на тему со стрелочками"
